export default function CuerpoTextoPrincipal() {
    return (
        <div className="container">
            <div className="row">
                ...
                </div><p>Esta plataforma se establece con el propósito de facilitar el proceso de presentar denuncias relacionadas con la conducta de los ministerios públicos, jueces y defensores públicos en el ejercicio de administrar la justicia. Reconociendo que la justicia desempeña un papel fundamental en cualquier sociedad al permitir el control del delito y abordar los abusos, ya sea por exceso de autoridad o por negligencia en el cumplimiento de sus responsabilidades. Es imperativo que los ciudadanos se pronuncien colectivamente para dirigir los esfuerzos hacia la corrección de estas cuestiones. La única vía para lograrlo es mediante el estricto cumplimiento de la ley.</p>
